...
"]
   ...
   [:p.notes "C Major is " [:b "C D E F G A B"]]
   [:p.notes "A Minor is " [:b "A B C D E F G"]]

   [:hr]
   [:p.notes "G Major is " [:b "G A B C D E F#"]]	
   [:p.notes "E Minor is " [:b "E F# G A B C D"]]	

   [:hr]
   [:p.notes "D Major is " [:b "D E F# G A B C#"]]	
   [:p.notes "B Minor is " [:b "B C# D E F# G A"]]	
